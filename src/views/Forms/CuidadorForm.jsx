...
import { Box, Button, Radio, TextField, Typography, Input } from '@mui/material';
...
export const CuidadorForm = () => {
    ...
    return (
        <>
            {modalOpen && <ModalUi modalOpen={modalOpen} setModalOpen={setModalOpen} id={caretakerProfile.id} />}
            <Box sx={{ marginBottom: 2, paddingX: 2 }}>
                <Typography variant='h4'>Fill in this form and start recievieng pets!</Typography>
                <TextField
                    fullWidth
                    rows={4}
                ...
                <div>
                    ...
                    <br />
                    <input type='file' name='image' onChange={handleFileInputChange} value={fileInputState} multiple />
                    {/* <button type='submit'>Upload</button> */}
                    {/* </form> */}
                    {form.images?.length &&
                        form.images.map((image) => <img src={image} alt='img' style={{ height: '300px' }} />)}
                    {form.images?.length && (
                        <>
                            <br></br>
                            <Button onClick={() => setForm({ ...form, images: [] })}>Delete</Button>
                        </>
                    )}
                </div>
                {errors.images && (
                ...
                >
                    ...
                    >
                        ...
                        />
                        <LocationFinderDummy />
                        {form.lat !== null && <Marker position={[form.lat, form.lng]} anchor='center' />}
                    </MapContainer>
                </Box>

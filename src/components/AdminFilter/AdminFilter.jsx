...
const AdminFilter = ({ order, filter, search, perPage, setPage, setPerPage, setOrder, setFilter, setSearch }) => {
    ...
    return (
        <Box width='100%' display='flex' flexDirection={'row'} justifyContent={'space-around'}>
            ...
            <FormControl sx={{ width: '10%' }}>
                ...
                <Select labelId='state' name='state' value={filter.state} label='State' onChange={handleFilter}>
                    <MenuItem value={'all'}>All</MenuItem>
                    <MenuItem value={'yes'}>Active Users</MenuItem>
                    <MenuItem value={'no'}>Inactive Users</MenuItem>
                </Select>
            </FormControl>
            <FormControl sx={{ width: '10%' }}>
            ...
            <FormControl sx={{ width: '10%' }}>
                ...
                <Select labelId='role' name='role' value={filter.role} label='Role' onChange={handleFilter}>
                    <MenuItem value={'all'}>All</MenuItem>

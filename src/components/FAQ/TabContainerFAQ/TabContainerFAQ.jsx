	...
	return (
		<Box sx={{ width: '100%' }}>
			<Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
				...
				>
					<Tab label='PetTripp' {...a11yProps(0)} className='no-focus' />
					<Tab label='User' {...a11yProps(1)} className='no-focus' />
					<Tab label='Caretaker' {...a11yProps(2)} className='no-focus' />
					<Tab label='Payment' {...a11yProps(3)} className='no-focus' />
				</Tabs>
			</Box>
